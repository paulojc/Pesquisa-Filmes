...
function buscarFilmes(filmePesquisa){
	axios.get('http://www.omdbapi.com/?s=' + filmePesquisa + '&apikey=5d587633')
		...
		for(var i = 0; i < filmes.length; i ++){
			mostrarFilmes += `
				<div class="col-sm-6 col-md-4">
					<div class="thumbnail">
						<img src="${filmes[i].Poster}" class="img.thumbnail"></img>
...
function mostraFilme(){
	...
	axios.get('http://www.omdbapi.com/?i=' + filmeID + '&apikey=5d587633')
	.then(function (response){
		...
		var mostraFilme = `
			...
			<div class="col-md-6">
				<div class="well clearfix">
					...
					${filme.Plot}
					<hr>
					<a href="http://www.imdb.com/title/${filme.imdbID}" target="_blank" class="btn btn-success" pull-left">Ver no IMDB</a>
					<a href="javascript:window.history.go(-1)" target="_blank" class="btn btn-default" pull-right">Voltar a Pesquisa</a>
				</div>
			</div>
		`
